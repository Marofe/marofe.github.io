...
const Note = () => {
    ...
    const title="Dispositivos Eletrônicos: o Diodo";
    const description="Nesse post é apresentado os conceitos elementares sobre os materiais semicondutores, como é feita a dopagem e a construção de materiais do tipo-P e do tipo-N. Em seguida é discutido o fenômeno que ocorre quando é feita a junção de um material tipo-P ao um do tipo-N. Resultando na junção PN em que é dado o nome de diodo. O mais simples dos dispositivos eletrônicos.";
